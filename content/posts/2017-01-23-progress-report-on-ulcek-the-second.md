---
title: "Progress Report on ULCEK, the second"
...
- Put together a simple circuit

- How to use a light sensor

- How to use a button

- How to light multiple LEDs

- How to use a library (to control our RGB ring)

- How to control the lighting of this ring with the light sensor

- How to turn off the board completely
